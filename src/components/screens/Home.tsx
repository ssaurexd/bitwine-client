...
const Home: FC<Props> = ({ dataResp }) => {
	...
	return (
		<div>
			<div>
				Lorem ipsum dolor sit amet consectetur adipisicing elit. Exercitationem, voluptates recusandae. Qui, ipsum! Non ipsa doloribus nemo, officia aut dolores numquam, corporis commodi quaerat tempora id deleniti! Ad, impedit beatae!
			</div>
			<div>
				Lorem ipsum dolor sit amet consectetur adipisicing elit. Exercitationem, voluptates recusandae. Qui, ipsum! Non ipsa doloribus nemo, officia aut dolores numquam, corporis commodi quaerat tempora id deleniti! Ad, impedit beatae!
			</div>
